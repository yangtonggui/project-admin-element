  ...
  <div class="login">
    ...
    <div class="info">
      ...
      <div class="prompt">
        ...
        <el-input placeholder="账号" style="width: 80% ;height:40px" name="id" v-model="name" value="id"  :maxlength="18"></el-input>
        <p class="line"></p>
      </div>
      <div class="prompt">
        <svg-icon icon-class="login_lock" class-name="infologo"></svg-icon>
        <el-input type="password" @keyup.enter.native="subbtn" placeholder="密码" style="width: 80% ;height:40px;  " name="password" v-model="password"  :maxlength="18" ></el-input>
        <p class="line"></p>
      </div>
